        ...
        <div class="content-header">
            <div class="container">
                <div class="d-flex justify-content-between">
                    <h3>Supplier</h3>
                    <div class="">
                        <router-link :to="{name: 'supplier/show', params:{id: this.$route.params.id}}" class="btn btn-info">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img v-if="form.new_avatar == null" :src="form.avatar != 'default.png' ? '/backend/supplier/'+form.avatar:'https://via.placeholder.com/240.png'" alt="" width="40px" height="40px" class="img-fluid">
