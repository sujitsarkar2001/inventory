        ...
        <div class="content-header">
            <div class="container">
                <div class="d-flex justify-content-between">
                    <h3>Product</h3>
                    <div class="">
                        <router-link :to="{name: 'product/show', params:{id: this.$route.params.id}}" class="btn btn-info">
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control select2" v-model="form.category_id" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control select2" v-model="form.supplier_id" required>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            :class="{ 'is-invalid': form.errors.has('code') }" required>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            :class="{ 'is-invalid': form.errors.has('root') }" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            :class="{ 'is-invalid': form.errors.has('qty') }" required>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            :class="{ 'is-invalid': form.errors.has('buying_price') }" required>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            :class="{ 'is-invalid': form.errors.has('selling_price') }" required>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            :class="{ 'is-invalid': form.errors.has('buy_date') }" required>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img v-if="form.new_avatar == null" :src="form.image != 'default.png' ? '/backend/product/'+form.image:'https://via.placeholder.com/240.png'" alt="" width="40px" height="40px" class="img-fluid">
    ...
    created() {
        ...
        axios.get('/api/product/'+id)
            .then(response => {
                ...
                this.supplier_id = response.data.data.supplier_id
            })
            .catch(e => {
                this.$router.push({ name: 'product' })
